...
export default function TitanUltimateExperience() {
  ...
  return (
    <main className="bg-white text-black min-h-screen selection:bg-blue-600/40 font-sans overflow-x-hidden">
        ...
        {view === "home" ? (
          <motion.div key="home-view" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <section className="relative h-[80vh] md:h-[90vh] flex items-center justify-center overflow-hidden bg-white">
              ...
              >
                <motion.h1 variants={fadeInUpVariants} className="text-[18vw] md:text-[15vw] font-black italic uppercase leading-none tracking-tighter text-black drop-shadow-sm">
                  TITAN.
                </motion.h1>
                <motion.p variants={fadeInUpVariants} className="tracking-[0.5em] md:tracking-[1em] text-[10px] md:text-[12px] text-blue-600 font-bold mt-4">
                  POWERED BY QUANTUM
                </motion.p>
                <motion.button 
                  variants={fadeInUpVariants} 
                  onClick={() => setView("telefona")} 
                  className="mt-8 md:mt-12 bg-black text-white px-8 md:px-12 py-4 md:py-5 rounded-full font-black uppercase text-[10px] md:text-xs tracking-widest hover:bg-blue-600 hover:scale-105 transition-all shadow-2xl"
                >
                  Eksploro Katalogun
                </motion.button>
              </motion.div>
      ...
      <footer className="py-20 border-t border-black/5 bg-white text-center">
