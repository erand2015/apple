...
export const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "bg-black [border:1px_solid_rgba(255,255,255,.1)]",
      className,
    )}
  >
    <div>{background}</div>
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      ...
      <h3 className="text-xl font-serif italic text-white">{name}</h3>
      <p className="max-w-lg text-neutral-400 text-sm font-light leading-relaxed">{description}</p>
    </div>
